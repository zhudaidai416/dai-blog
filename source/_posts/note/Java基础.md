...
![字节](/assets/images/字节.png)

### 字符的存储原理

ASCII 编码表：即美国信息交换标准编码，规定了现代英语、数字字符、和其他西欧字符对应的数字编号

![ASCII编码表](/assets/images/ASCII编码表.png)
...
![十进制转二进制](/assets/images/十进制转二进制.png)
...
![自动类型转换原理](/assets/images/自动类型转换原理.png)

**自动类型转换的其它形式：**

![自动类型转换](/assets/images/自动类型转换.png)
...
![强制类型转换原理](/assets/images/强制类型转换原理.png)
