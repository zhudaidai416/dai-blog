...
const randomBG = function (count = 1, image_server = null, image_list = []) {
  ...
  var parseImage = function (img, size) {
    if (img.startsWith("//") || img.startsWith("http")) {
      ...
      // return 'https://images.weserv.nl/?url=https://github.com/zhudaidai416/blog-image/raw/master/banner/' + img
      return "https://daiblog.oss-cn-chengdu.aliyuncs.com/cover/" + img;
    }
  };
